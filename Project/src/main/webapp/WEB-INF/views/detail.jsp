...
<script type="text/javascript" src="/webjars/bootstrap/3.3.4/dist/js/bootstrap.min.js"></script>
	...
	<%
		...
		String apiUrl="https://api.themoviedb.org/3/movie/"
				+"370172?"
				+"api_key=68ec3922f6c79f2f0574d8af0cce9fa8&language=ko-KR";
...
<body>
	...
	<form action="/detail/insert" method="post">
		<textarea name="detailcontent" rows="8" style="resize: none;"></textarea>
	...
	<c:forEach items="${detailList }" var="bean">
		<table class="table table-bordered">
			<tr>
				<td>${bean.detailid }</td>
				<td>${bean.detailnalja }
					<form class="table_deleteForm" action="/detail/delete" method="post">
						<input type="hidden" name="detailno" value="${bean.detailno }">
						<button style="width: 40px;" type="submit">삭제</button>
					</form>
				</td>
			</tr>
			<tr>
